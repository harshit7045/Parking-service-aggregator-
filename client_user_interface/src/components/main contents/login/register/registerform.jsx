    ...
    <div className="p-4 max-w-md mx-auto border sm:max-w-lg sm:mx-auto sm:p-8 lg:max-w-full lg:mx-0 lg:p-8">
      <form className="lg:w-full lg:flex lg:flex-col lg:items-center">
        ...
        {[...Array(numVehicles)].map((_, index) => (
          <div key={index}>
            <div className="mb-4 w-full">
              <label className="block text-gray-700">Unique Identification for Vehicle {index + 1}</label>
              <input
                type="text"
                name="uid"
            ...
            <div className="mb-4 w-full">
              <label className="block text-gray-700">Vehicle Number for Vehicle {index + 1}</label>
              <input
                type="text"
                name="vehicleNumber"
            ...
            <div className="mb-4 w-full">
              <label className="block text-gray-700">Category for Vehicle {index + 1}</label>
              <input
                type="text"
                name="category"
        ...
        <div className="flex text-center justify-center w-full">
          ...
          <button type="button" className="px-4 py-2 bg-[#b16163] text-white font-bold rounded ">
            Register
          </button>
        </div>
      </form>
