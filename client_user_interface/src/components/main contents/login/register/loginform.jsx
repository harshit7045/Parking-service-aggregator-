      ...
      <div className="relative z-10 flex items-center justify-center h-screen w-full px-5 sm:px-0">
        <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
          <div
            ...
            style={{
              backgroundImage: `url(https://th.bing.com/th/id/OIP.YXIT9zflAjU8s6ulI0f6sgAAAA?rs=1&pid=ImgDetMain)`,
            }}
          ></div>
          <div className="w-full p-8 lg:w-1/2">
            ...
            >
              <div className="flex px-5 justify-center w-full py-3 bg-[#b16163]">
