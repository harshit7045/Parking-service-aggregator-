...
export default function BooklotPopup() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-10 max-w-full overflow-x-hidden box-border">
      {/* Main content container */}
      <div className="flex flex-col lg:flex-row justify-center items-start gap-8 w-full">
        {/* Pie chart container */}
        <div className="bg-white shadow-lg rounded-lg p-6 lg:w-1/2 w-full box-border">
          <h2 className="text-xl font-semibold text-gray-700 mb-4 text-center">
            Parking Lots Visualization
          </h2>
          <div className="h-[40vh] w-[80vw]  lg:w-auto lg:h-[70vh]">
        ...
        <div className="w-full lg:w-[30vw] flex flex-col gap-6">
          {/* Table for Lot Data */}
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2 hover:bg-green-100">
